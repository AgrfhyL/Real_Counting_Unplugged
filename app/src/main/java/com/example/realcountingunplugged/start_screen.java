...
public class start_screen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        randPara = findViewById(R.id.randParaButton);
        ...
        randPara.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(start_screen.this, random_paragraph.class);
                startActivity(intent);
            }
        });
        ...
        wordSearchButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(start_screen.this, word_search.class);
                startActivity(intent);
            }
        });
